...
(function (global, factory) {
  ...
  function useHref(to) {
    ...
    if (basename !== "/") {
      let toPathname = router.getToPathname(to); // Only append a trailing slash to the raw basename if the basename doesn't
      ...
      if (pathname !== "/") {
        joinedPathname = router.joinPaths([basename, pathname]);
      } else if (appendSlash) {
  ...
  function useNavigate() {
    ...
    let navigate = React__namespace.useCallback(function (to, options) {
      ...
      if (basename !== "/") {
        ...
        let toPath = typeof to === "string" ? router.parsePath(to) : to;
        let isBlankPath = toPath.pathname == null || toPath.pathname === "";
        path.pathname = isBlankPath ? basename : router.joinPaths([basename, path.pathname]);
      }
