 ...
 * @private
 */
export declare function useRenderDataRouter({ children, fallbackElement, routes, createRouter, }: {
...
export declare function DataMemoryRouter({ children, initialEntries, initialIndex, hydrationData, fallbackElement, routes, }: DataMemoryRouterProps): React.ReactElement;
